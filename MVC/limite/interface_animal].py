...
class AnimalView:
  ...
  layout = [[sg.Text("Cadastre as informações do Animal!", size=(30, 1), font=("Helvetica", 25))]
            ...
            [sg.Radio("Fêmea", "RD1", default=True, key="rd_femea"), sg.Radio("Macho", "RD1", key="rd_macho")],
            [sg.Text("O animal possui doenças?:")],
            [sg.Radio("Possui", "RD1", default=True, key="rd_sim"), sg.Radio("Não possui", "RD1", key="rd_nao")],
            [sg.Text("O Animal está vacinado?:")],
            [sg.Radio("Sim", "RD1", default=True, key="rd_vacinado"), sg.Radio("Não", "RD1", key="rd_naovacinado")],
            [sg.Text("O Animal está castrado?:")],
            [sg.Radio("Sim", "RD1", default=True, key="rd_castrado"), sg.Radio("Não", "RD1", key="rd_naocastrado")]]
